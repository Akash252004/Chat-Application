<?php 
    ...
    // Ensure $_SESSION['user_email'] is set
    if(!isset($_SESSION['user_email'])){
        header("location: signin.php");
        exit(); // Add exit after redirection
    }

    // Define $username1 to avoid undefined variable notice
    $username1 = "";
    $user_profile_image = "";
    ...
    // Get user data based on the clicked username
    ...
    // Get total messages the logged-in user and the clicked user
    $total_messages = "SELECT * FROM users_chats WHERE (sender_username = '$user_name' AND receiver_username = '$username1') OR (receiver_username = '$user_name' AND sender_username = '$username1')";
